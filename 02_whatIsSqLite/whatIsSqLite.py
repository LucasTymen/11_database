...
This fact allows for a great deal of accessibility:
copying a database is no more complicated than copying the file that stores the data, sharing a database can mean sending an email attachment.
Drawbacks to SQLite
...
Congratulations! For more info, check our article on other Relational Database Management Systems.
